...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RealTimePolicy) DeepCopyObject() runtime.Object {
        if c := in.DeepCopy(); c != nil {
                return c
        }
        return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RealTimePolicyList) DeepCopyInto(out *RealTimePolicyList) {
        *out = *in
        out.TypeMeta = in.TypeMeta
        in.ListMeta.DeepCopyInto(&out.ListMeta)
        if in.Items != nil {
                in, out := &in.Items, &out.Items
                *out = make([]RealTimePolicy, len(*in))
                for i := range *in {
                        (*in)[i].DeepCopyInto(&(*out)[i])
                }
        }
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RealTimePolicyList.
func (in *RealTimePolicyList) DeepCopy() *RealTimePolicyList {
        if in == nil {
                return nil
        }
        out := new(RealTimePolicyList)
        in.DeepCopyInto(out)
        return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RealTimePolicyList) DeepCopyObject() runtime.Object {
        if c := in.DeepCopy(); c != nil {
                return c
        }
        return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RealTimePolicySpec) DeepCopyInto(out *RealTimePolicySpec) {
        *out = *in
        in.Config.DeepCopyInto(&out.Config)
        in.Control.DeepCopyInto(&out.Control)
        in.Log.DeepCopyInto(&out.Log)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RealTimePolicySpec.
func (in *RealTimePolicySpec) DeepCopy() *RealTimePolicySpec {
        if in == nil {
                return nil
        }
        out := new(RealTimePolicySpec)
        in.DeepCopyInto(out)
        return out
}
